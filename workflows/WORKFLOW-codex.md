...
polling:
  interval_ms: 30000
workspace:
  root: ~/symphony-workspaces/codex
hooks:
  after_create: |
...
agent:
  ...
  max_turns: 20
codex:
  command: /Users/shan/.local/bin/codex --config shell_environment_policy.inherit=all --config model_reasoning_effort=high app-server
